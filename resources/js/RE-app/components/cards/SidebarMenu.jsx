...
const SidebarMenu = ({menuActive, setMenuActive}) => {
  ...
  return (
    <>
      <div className="absolute z-20 left-0 top-0 flex flex-col bg-clip-padding backdrop-filter backdrop-blur-lg bg-white/30 text-gray-700 h-[calc(100vh-2rem)] w-full h-full max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5 border border-gray-200/30" style={sidebarStyle}>
        <button
        ...
        <div className="mb-2 mr-auto p-4 flex items-center">
          <div className="logo w-16 md:block hidden ml-0">
            <img src="src\assets\website-design\logo.png" alt="logo" />
          </div>
