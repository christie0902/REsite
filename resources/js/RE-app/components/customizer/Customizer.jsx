...
const Customizer = () => {
  ...
  const generateTabContent = () => {
    switch (activeEditorTab) {
      ...
      case "preset":
        return <Preset file={file} handleFile={handleFile} setFile={setFile} />;
        ...
        <>
          ...
          >
            <CustomButton
              ...
              title="Go Back"
              handleClick={() =>
                dispatch({ type: "customizer/set-intro", payload: true })
              }
                ...
                handleClick={() => {
                  if (tab.name === "download") {
                    ...
                    dispatch({
                      ...
                      payload: { id: Math.random().toString(), name: "Customize Tshirt" , image_url: canvasURL, price: "50", size: "Free size", quantity: 1},
                    });
                  }
                  else {
