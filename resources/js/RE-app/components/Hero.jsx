      ...
      <div>
        ...
        <div className="info-container">
          <div className="recon-info">
            ...
            <div className="recon-header">
              ...
              <div className="recon-description">Special edition from RE3</div>
            </div>
          </div>
          ...
          <div className="bottom-info">
            <div className="bottom-description">Dimension 20x50</div>
          </div>
        </div>
        ...
        <div className="right-side-info">
          <div className="top-info">
            <div className="top-description">The best seller character</div>
          </div>
          <div className="second-info">
            <div className="second-description">Over <strong>500</strong> pre-orders!!!</div>
          </div>
