  ...
  return (
    <>
        ...
        <div className="category-header">
            ...
            <p className="category-description">Explore our amazing models, realistic collectibles, impressive costume and a lot more in our shop!</p>
            <Link to={"/shop"}><CustomButton className="category-button" type="static" title="SHOP NOW"/></Link>
        </div>
