...
const Footer = () => {
  return (
    <footer className="p-4 sm:p-6 bg-black ">
      <div className="mx-auto max-w-screen-xl text-white mt-5">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span
            className="text-sm text-gray-800 sm:text-center"
          >
            © 2024 R.E.MALL™. All Rights Reserved.
          </span>
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="#" className="text-gray-500 hover:text-[#294861]">
              <svg
                className="w-5 h-5"
                fill="currentColor"
                viewBox="0 0 24 24"
...
{
  /* <footer className="p-4 sm:p-6 bg-gradient-to-r from-[#294861] to-[#8B0000]"></footer> */
}
