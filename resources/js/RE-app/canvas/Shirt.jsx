...
const Shirt = () => {
  ...
  const { nodes, materials } = useGLTF("https://res.cloudinary.com/diwszstai/image/upload/v1710794781/site-assets/shirt_baked_lfhhqu.glb");
  ...
  useFrame((state,delta)=> easing.dampC (materials.lambert1.color, appState.customizerState.color, 0.25, delta));
