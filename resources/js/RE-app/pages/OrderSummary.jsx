...
function OrderSummary() {
    ...
    return (
        ...
        <h1 className="text-3xl font-bold mb-4 text-yellow-500">Order Summary</h1>
        <div className="flex flex-wrap justify-between">
            <div className="w-full lg:w-2/3 mb-8 lg:mb-0 pr-4">
                ...
                <div className="order-summary-container backdrop-blur-md bg-white/10 border border-gray-500/50 shadow-lg p-6 mb-8">
                    ...
                    <div className="order-items space-y-4">
                        {items.map(({ product, quantity, price, variant_description }, index) => (
                            <div key={index} className="order-item flex items-center space-x-4">
                ...
                <div className="order-summary backdrop-blur-md bg-white/10 border border-gray-500/50 shadow-lg p-6  mb-8 w-full">
                    ...
                    <p className="text-2xl font-bold text-gray-200 mb-2 mt-10">
                        Subtotal: <span className="text-yellow-500">${total_price}</span>
                    </p>
                </div>
                {/* Delivery */}
                <div className="shipping-info backdrop-blur-md bg-white/10 border border-gray-500/50 shadow-lg p-6 w-full ">
                    <h2 className="text-xl font-bold mb-4">DPD Deliver</h2>
                    <div className="flex justify-between">
                    <p>Deliver within 3 days</p>
                    <p>$10.00</p>
                    </div>
                    <button className="mt-4 bg-yellow-700 text-white px-4 py-2 rounded hover:bg-yellow-600">View Carrier Details</button>
                </div>
                </div>
            ...
            <div className="w-full lg:w-1/3 lg:pl-4">
                <div className="customer-info backdrop-blur-md bg-white/10 border border-gray-500/50 shadow-lg p-6 h-full">
                    ...
                    <button className="mt-4 bg-yellow-700 text-white px-4 py-2 rounded hover:bg-yellow-600">Edit Details</button>
                </div>
            </div>
        </div>
    </div>
